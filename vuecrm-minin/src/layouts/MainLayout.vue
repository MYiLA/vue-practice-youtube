<template>
  <div class="app-main-layout">
    ...
    <main class="app-content">
      <div class="app-page">
        <!-- шаг 2. контент оберток удаляем(которые будут подгружаться с индивидуальными данными)
        Мы сначала вычленяем общие блоки для всех страниц, чтобы после подгружать в них компоненты -->
